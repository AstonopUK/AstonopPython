...
while replay == True:
    ...
    for y in range(gridsize):
            ...
            #print(newString)
            #print("\n")
            totalStringOutput += newString + "\n"

    root = Tk()
    gridLabel = StringVar()
    root.title("Boggle Pro")
    gridLabel.set("New Test Text")
    playLabel = Label(root, textvariable = gridLabel)
    playLabel.pack(fill = X, padx = 140, pady = 180)
    
    gridLabel.set(totalStringOutput)
